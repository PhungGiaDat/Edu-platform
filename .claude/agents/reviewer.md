...
- `.claude/skills/code-review/SKILL.md` — Review checklists, severity levels, code smells
- `.claude/skills/code-intelligence/SKILL.md` — Decision tree: when to use LSP vs AST-Grep
- `.claude/skills/ast-grep/SKILL.md` — AST-Grep pattern syntax, commands, language examples
