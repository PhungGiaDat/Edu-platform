...
<!-- USER: Edit these values for your project -->
```yaml
deployment:
...
- `.claude/skills/devops-automation/SKILL.md` — CI/CD, Docker, Kubernetes templates
- `.claude/skills/docker-containerization/SKILL.md` — Dockerfile patterns

## Deployment Environments

```
@devops deploy [app] to [environment] with domain [domain]
```
