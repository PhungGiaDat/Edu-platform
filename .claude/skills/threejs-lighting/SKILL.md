...
description: Three.js lighting - light types, shadows, environment lighting, IBL. Use when adding lights to scenes, configuring shadows, setting up environment maps, or optimizing light performance.
---

# Three.js Lighting

This skill file covers Three.js lighting concepts including light types, shadows, environment lighting, and optimization techniques.
