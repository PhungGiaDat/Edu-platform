...
description: Three.js animation - keyframes, skeletal animation, morph targets, blending. Use when creating animations, playing GLTF animations, blending animation states, or implementing procedural motion.
---
