...
description: Three.js textures - loading, configuring, cube maps, render targets. Use when loading textures, configuring UVs, creating procedural textures, or setting up environment maps.
---
