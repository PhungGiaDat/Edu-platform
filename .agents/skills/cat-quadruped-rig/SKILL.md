...
This is the Codex-host mirror of the same skill that lives in `.cursor/skills/cat-quadruped-rig/SKILL.md`. Keep both files in sync.
...
| Need | Source |
|------|--------|
| Rigging, FK/IK, keyframes, NLA, FCurves | `ra100/blender-Codex-plugin/skills/blender-animation-rigging/SKILL.md` |
| Safe MCP execution patterns | `NousResearch/hermes-agent/optional-skills/creative/blender-mcp/SKILL.md` |
| Pose/deformation QA | `affaan-m/everything-Codex/skills/blender-motion-state-inspection/SKILL.md` |
