...
These patterns target the most dangerous Codex failure mode: **plausible-looking math that compiles but produces wrong results**. Each pattern documents Codex's default mistake and the correct Unity approach.
