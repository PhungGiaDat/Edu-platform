---
name: ar-state-machine
description: Migrated OpenCode skill `ar-state-machine`. Use when working on ar state machine skill guidance, patterns, or implementation details.
---
