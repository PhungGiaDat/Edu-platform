---
name: mindar-integration
description: Migrated OpenCode skill `mindar-integration`. Use when working on mindar integration skill guidance, patterns, or implementation details.
---
