...
description: Migrated OpenCode skill `multi-target-tracking`. Use when working on multi-target image tracking skill guidance, patterns, or implementation details.
---
