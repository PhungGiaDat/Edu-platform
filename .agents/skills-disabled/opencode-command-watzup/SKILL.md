---
name: opencode-command-watzup
description: Migrated OpenCode slash command `watzup`. Use when the user asks to run or follow the old OpenCode `/watzup` workflow.
---

# opencode-command-watzup

This skill was migrated from `.opencode/commands/watzup.md`.
