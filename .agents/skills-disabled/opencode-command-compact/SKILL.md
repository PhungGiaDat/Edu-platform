---
name: opencode-command-compact
description: Migrated OpenCode slash command `compact`. Use when the user asks to run or follow the old OpenCode `/compact` workflow.
---

# opencode-command-compact

This skill was migrated from `.opencode/commands/compact.md`.
