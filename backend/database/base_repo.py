"""
Base repository — MongoDB-only operations.

When postgres_core_enabled=True all callers must use the specific asyncpg
repositories (e.g. gamification_repository, postgres_user_repository) instead
...
class BaseRepository:
    ...
    def __init__(self, collection_name: str):
        # Raises RuntimeError when postgres_core_enabled=True — callers must
        # route to the appropriate asyncpg repository instead.
