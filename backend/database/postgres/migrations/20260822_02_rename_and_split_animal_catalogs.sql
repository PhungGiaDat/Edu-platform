-- Migration: 20260822_02_rename_and_split_animal_catalogs.sql
-- Split claymorphic-v1 into two catalogs:
-- 1. animals-v2  = 2 animals (elephant, shiba) — existing animals-v2.mind
-- 2. animal-v1    = 5 animals for single-card mode (cat, rabbit, elephant, panda, tiger)
-- 3. animal-combo-v1 = 10 cards (animals + food) for combo mode

BEGIN;

-- ============================================================================
-- 1. animals-v2: 2 animal targets (existing, from animals-v2.mind)
-- ============================================================================
