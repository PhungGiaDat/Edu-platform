...
BADGE_DEFINITIONS: Dict[str, dict] = {
    ...
    "first_scan": {
        "name": "First Scan",
        "emoji": "🔍",
        "description": "Scanned your first flashcard!",
        "xp_reward": 50,
    },
    "quiz_starter": {
        "name": "Quiz Starter",
    ...
    "combo_hunter": {
        "name": "Combo Hunter",
        "emoji": "🎯",
        "description": "Found a flashcard combo!",
        "xp_reward": 75,
    },
    "pronunciation_pro": {
    ...
    "pronunciation_pro_5": {
        ...
        "emoji": "🌟",
        "description": "Made 5 pronunciation attempts!",
        "xp_reward": 75,
    },
    "topic_master": {
        "name": "Topic Master",
        "emoji": "📖",
        "description": "Mastered all words in a topic!",
        "xp_reward": 150,
    },
    "time_keeper": {
        "name": "Time Keeper",
        "emoji": "⏰",
        "description": "Took a break on time — well done!",
        "xp_reward": 50,
    },
}
...
XP_REWARDS: Dict[str, int] = {
    ...
    # Kid notebook review (no-fail box ladder) — participation-focused
    "notebook_review_completed": 5,  # Any review swipe (shows up = rewarded)
    "notebook_box_up": 5,  # Progressed one mastery box (bonus)
}
