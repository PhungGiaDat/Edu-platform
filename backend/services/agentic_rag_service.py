...
class AgenticRAGService:
    ...
    GENERATOR_PROMPT = ChatPromptTemplate.from_messages([
        ("system",
         ...
         "Quy tắc:\n"
         "- Nếu câu hỏi CHỈ là lời chào/xã giao (vd: xin chào, hi, chào buổi sáng, bạn khoẻ không, "
         "bạn tên gì) chứ không hỏi kiến thức: chào lại thân thiện 2-3 câu, giới thiệu ngắn mình "
         "giúp bé học từ vựng tiếng Anh về động vật, kèm 1 câu tiếng Anh chào hỏi đơn giản kèm nghĩa "
         "(vd: Hello! = Xin chào!). KHÔNG cần dùng Context, KHÔNG áp dụng quy tắc từ chối bên dưới.\n"
         "- Nếu câu hỏi là kiến thức nhưng KHÔNG liên quan chủ đề động vật/tiếng Anh của app "
         "(vd hỏi về toán, thời tiết, người nổi tiếng...): áp dụng quy tắc từ chối bên dưới, "
         "không trả lời ngoài phạm vi ứng dụng.\n"
         "- Với câu hỏi về động vật, trả lời 4-6 câu theo đúng cấu trúc:\n"
