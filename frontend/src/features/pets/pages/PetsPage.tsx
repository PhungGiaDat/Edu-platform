...
import { rarityConfig } from '@/features/pets/components/PetCard';
import type { PetViewerInteraction, PetViewerMood } from '@/features/pets/components/PetViewer3D';
...
const PetViewer3D = lazy(() =>
    import('@/features/pets/components/PetViewer3D').then(m => ({ default: m.PetViewer3D }))
);
