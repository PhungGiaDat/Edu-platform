        ...
        <>
            ...
            {!isOpen && show3DPet && (
                <button
                    ...
                    className={`ai-chat-buddy__fab group fixed right-3.5 flex h-[54px] w-[54px] cursor-pointer items-center justify-center rounded-full p-0 transition-transform duration-300 sm:right-4 sm:h-16 sm:w-16 md:bottom-6 md:right-6 md:h-20 md:w-20 lg:h-[92px] lg:w-[92px] ${lessonContext ? 'bottom-[calc(var(--lesson-bottom-action-height,4.5rem)+env(safe-area-inset-bottom,0px)+1.5rem)]' : 'bottom-4'}`}
                    style={{
