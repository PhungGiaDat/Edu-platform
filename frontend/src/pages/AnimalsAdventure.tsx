...
const fallbackCourse = {
  ...
  thumbnail_url: '/assets/animals/clay-v1/cat-champion-clay-v1-512.png',
  catalogPreview: [],
  studentTestimonials: [],
  lessons: [
    {
      ...
      video_duration: 0,
      vocabulary: [
        { word_en: 'Cat', word_vi: 'con mèo', emoji: '🐱', image: '/assets/animals/clay-v1/cat-vocabulary-clay-v1-512.png', simple_sentence: 'The cat is small.' },
        { word_en: 'Dog', word_vi: 'con chó', emoji: '🐶', image: '/assets/animals/clay-v1/dog-vocabulary-clay-v1-512.png', simple_sentence: 'The dog is big.' },
        { word_en: 'Bird', word_vi: 'con chim', emoji: '🐦', image: '/assets/animals/clay-v1/bird-vocabulary-clay-v1-512.png', simple_sentence: 'The bird can fly.' },
        { word_en: 'Fish', word_vi: 'con cá', emoji: '🐟', image: '/assets/animals/clay-v1/cat-vocabulary-clay-v1-512.png', simple_sentence: 'The fish swims.' },
        { word_en: 'Rabbit', word_vi: 'con thỏ', emoji: '🐰', image: '/assets/animals/clay-v1/cat-vocabulary-clay-v1-512.png', simple_sentence: 'The rabbit hops.' },
      ],
      quiz: [],
      images: ['/assets/animals/clay-v1/cat-vocabulary-clay-v1-512.png'],
      scene_images: ['/assets/animals/clay-v1/cat-champion-clay-v1-512.png'],
      generatedMedia: [],
    },
    {
      ...
      quiz: [],
      images: ['/assets/animals/clay-v1/dog-vocabulary-clay-v1-512.png'],
      scene_images: [],
      generatedMedia: [],
    },
    {
      ...
      quiz: [],
      images: ['/assets/animals/clay-v1/bird-vocabulary-clay-v1-512.png'],
      scene_images: [],
      generatedMedia: [],
    },
    {
