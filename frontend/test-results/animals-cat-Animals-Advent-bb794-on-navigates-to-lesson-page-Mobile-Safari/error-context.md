...
- Name: animals-cat.spec.ts >> Animals Adventure Course >> Clicking Cat lesson navigates to lesson page
- Location: tests\e2e\animals-cat.spec.ts:63:3
...
Call log:
  - waiting for getByText('Cat').first()
